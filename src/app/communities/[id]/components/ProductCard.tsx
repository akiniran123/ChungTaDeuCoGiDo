...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <Link href={`/deal/${product.id}`} className="block">   {/* ⭐ Bọc toàn bộ card */}
      <article className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition overflow-hidden cursor-pointer">
