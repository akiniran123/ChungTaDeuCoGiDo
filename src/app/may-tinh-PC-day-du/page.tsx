...
<main className="flex-1">
  ...
  <div className="flex flex-col gap-4">
    {paginated.map((p) => (
      <article
        key={p.id}
        className="flex border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition cursor-pointer bg-white"
      >
        {/* Image left */}
          ...
          <div className="mt-auto flex items-center justify-between pt-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-green-600 text-white rounded text-sm cursor-pointer"
              >
                Mua
              </button>
            </div>
